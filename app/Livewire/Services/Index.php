...
class Index extends Component
{
    ...
    public function edit($id)
    {
        ...
        if ($service->type === 'ssh' && is_array($service->credentials)) {
            $this->ssh_username = $service->credentials['username'] ?? '';
            $this->ssh_password = $service->credentials['password'] ?? '';
        } else {
            $this->ssh_username = '';
            $this->ssh_password = '';
        }
    ...
    {
        $this->reset([
            'name', 'type', 'port', 'endpoint', 'serviceId', 'ssh_username', 'ssh_password'
        ]);
